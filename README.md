...
`系統毫秒`是靠 TIMER0 每1毫秒產生一個中斷去更新  <br />```大家有興趣可以去以下路徑查看 : embarc_osp-master\board\iotdk\common\iotdk_timer.c``` 
<br />```觀看順序 : iotdk_timer_init => iotdk_timer_isr => board_timer_update```  
